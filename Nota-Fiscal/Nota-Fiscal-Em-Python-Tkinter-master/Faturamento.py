...
window.title("Sistema De Gerar Cupons | junior15try@gmail.com")
...
def adminLogin():
    ...
    if admin:
        ...
        messagebox.showerror("junior15trygmail.com", "Usuario e Senha Erradas")
...
def mainwindow():
    ...
    updateItem = Button(window, text="Atualizar", bg="orange" , font=("bold", 10),fg="white",width=15, height=2,command=lambda: moveToUpdate()) # type: ignore
    updateItem.grid(row=1, column=1, padx=(10,0), pady=(10,0))

    showallEntry= Button(window, text="Lista", width=15, height=2, font=("bold", 10),bg="orange" ,fg="white",command=lambda:movetoBills()) # type: ignore
    showallEntry.grid(row=1, column=2, padx=(10,0), pady=(10,0))

    logoutBtn = Button(window, text = "Sair",width=15, height=2, font=("bold", 10),bg="orange" ,fg="white",command=lambda:LogOut()) # type: ignore
    ...
    buttonBill = Button(window, text="Add Para Lista", font=("bold", 10), width =15,bg="orange" ,fg="white", command=lambda:generateBill())
    ...
    totalCostLabel = Label(window, textvariable=totalCostVar) # type: ignore
    totalCostLabel.grid(row=6,column=1)
    generateBill = Button(window, text="Gerar Nota", font=("bold", 10),width=15, bg="orange" ,fg="white", command = lambda:printable())
